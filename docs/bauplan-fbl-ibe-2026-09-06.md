...
datum: 2026-09-06
status: verdrahtet
repo: ~/Projects/hotel-mulin-website
plankey: fbl-ibe
weitere_repos:
...
### Segment 2: hotel-mulin-website (MUBRIG): wie Segment 1, Kurtaxe inkludiert

- **Datei-Scope (exklusiv):**
  ```bauplan-scope segment=2
  # repo: hotel-mulin-website
  js/deeplink.js
  js/booking.js
  js/i18n.js
...
- **Akzeptanzkriterien:**
  ...
  - [ ] Mock-Body enthaelt bookingSource und campaign wie in Segment 1; __gtagCalls wie in Segment 1 mit id "MUBRIG"
  - [ ] js/booking.min.js und index.html unveraendert (git status zitiert); plausibleEvent unveraendert
  - [ ] Produktivcode-Diff hoechstens 400 Zeilen; kein Datei-Diff ausserhalb des Scopes; Plan-Abgleich in jedem Commit
  ```
- **Out-of-Scope:** Minify-Build, Cache-Bust, `index.html`, `locales/`, `local-api.js`.
- **Testplan:** wie Segment 1.
- **Hängt ab von:** Segment 0.
- **Diff geschätzt:** ~280 Zeilen Produktivcode.
