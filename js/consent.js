...
(function () {
  ...
  var TEXTS = {
    de: {
      ...
      text: 'Diese Website misst ihre Nutzung mit Google Analytics und den Erfolg unserer Werbung mit dem Meta-Pixel und Google Ads. Der Meta-Pixel und die Werbe-Cookies von Google Ads werden erst nach Ihrer Zustimmung geladen. Ihre Wahl können Sie jederzeit ändern.',
      accept: 'Akzeptieren',
      decline: 'Ablehnen',
      privacy: 'Datenschutz'
    },
    en: {
      ...
      text: 'This website measures its usage with Google Analytics, and how our advertising performs with the Meta pixel and Google Ads. The Meta pixel and Google Ads advertising cookies only load once you agree. You can change your choice at any time.',
      accept: 'Accept',
      decline: 'Decline',
      privacy: 'Privacy'
    }
